...
/**
 * Repräsentiert das logische Und für Wahrheitswerte oder die bitweise Und-Verknüpfung numerischer Werte.
 * 
 * @author Christoph Lembeck
 */
public class AndExpression extends AbstractExpression<ExpressionAndContext> {
    ...
    /**
     * Erzeugt eine neue AndExpression mit den übergebenen Werten.
     * 
     * @param ctx
     ...
     */
    public AndExpression(final ExpressionAndContext ctx, final Expression left, final Expression right) {
        super(ctx);
        this.left = left;
        this.right = right;
    }
