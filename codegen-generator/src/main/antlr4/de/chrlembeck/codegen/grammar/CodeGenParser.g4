...
executeStatement
    : LEFT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK EXEC (prefix=Identifier DOT)? templateName=Identifier 
         (FOR|FOREACH) valueExpression=expression (SEPARATOR separatorExpression=expression)? RIGHT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK
    ;    
 ...
 */
ifStatement
    : LEFT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK IF ifCondition=expression RIGHT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK ifBlock=userCodeOrStatements (LEFT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK ELSE RIGHT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK elseBlock=userCodeOrStatements)? LEFT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK ENDIF RIGHT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK
    ;
 ...
 */    
forStatement
    : LEFT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK FOREACH variableIdentifier=Identifier FROM valueExpression=expression (COUNTER counterIdentifier=Identifier)? (SEPARATOR separatorExpression=expression)? RIGHT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK loopBody=userCodeOrStatements LEFT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK ENDFOREACH RIGHT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK
    ;    
